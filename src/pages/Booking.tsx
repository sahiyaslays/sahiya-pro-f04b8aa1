...
const Booking = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-abel">
      <SEO 
        title="Book Hair Appointment Online | Sahiya Slays London E3"
        description="Book your hair appointment at Sahiya Slays, East London. Silk press, extensions, braids, colour & more. Easy online booking, instant confirmation."
        canonical="/booking"
        ogType="website"
        keywords="book hair appointment London, online booking hair salon, Sahiya Slays booking"
      />
      <Header />
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
            ...
            <div className="text-white">
              ...
              <a
                ...
                aria-label="Visit Sahiya Slays on Instagram"
              >
